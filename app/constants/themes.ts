const themes: any = {
    default:{
        ...
        borderKey: 'border-pinky text-white',
    ...
    dark:{
        ...
        highlightedKey: '!border-white bg-pinky-100 text-pinky',
        borderKey: 'border-white text-black',
        keyPressed: '!border-pinky !bg-pinky text-white',
